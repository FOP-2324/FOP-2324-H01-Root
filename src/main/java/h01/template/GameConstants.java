...
public final class GameConstants {
    public static int WORLD_WIDTH = getIntProperty("h01.properties", "WORLD_WIDTH");
    public static int WORLD_HEIGHT = getIntProperty("h01.properties", "WORLD_HEIGHT");
    ...
    public static int CONTAMINANT_ONE_MIN_PUT_COINS = getIntProperty(
        "h01.properties",
        "CONTAMINANT_ONE_MIN_PUT_COINS"
    );
    public static int CONTAMINANT_ONE_MAX_PUT_COINS = getIntProperty(
        "h01.properties",
        "CONTAMINANT_ONE_MAX_PUT_COINS"
    );
    public static int CLEANER_CAPACITY = getIntProperty("h01.properties", "CLEANER_CAPACITY");
